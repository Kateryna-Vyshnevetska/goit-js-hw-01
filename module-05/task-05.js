...
class Car {
   ...
   */
  constructor({speed = 0, maxSpeed, _price = 2000, isOn = false, distance = 0}) {
    this.speed = speed;
    this._price = _price;
  ...
  accelerate(value) {
    ...
    currentSpeed <= this.maxSpeed ? this.speed = currentSpeed : '';
  }
  ...
  decelerate(value) {
    const currentSpeed = this.speed - value
    currentSpeed > 0 ? this.speed = currentSpeed : '';
  }
